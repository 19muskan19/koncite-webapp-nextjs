...
const DPR: React.FC<DPRProps> = ({ theme }) => {
    ...
    const parseImages = (r: any): string[] => {
      ...
      const toUrls = (val: string | string[]) => {
        ...
        return arr.map((u: string) => {
          ...
          const base = String(process.env.NEXT_PUBLIC_API_URL || process.env.NEXT_PUBLIC_API_BASE_URL || 'https://backoffice.koncite.com/api').replace(/\/$/, '');
  ...
  const resolveImageUrl = (url: string): string => {
    ...
    const baseUrl = process.env.NEXT_PUBLIC_API_URL || process.env.NEXT_PUBLIC_API_BASE_URL || 'https://backoffice.koncite.com/api';
